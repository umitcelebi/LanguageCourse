...
namespace CourseApp.WebUI.Migrations
{
    ...
    [Migration("20210527130931_newModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApp.Entity.CourseProgramStudent", b =>
                {
                    ...
                    b.HasKey("StudentId", "CourseProgramId");

                    b.HasIndex("CourseProgramsId");

                    b.ToTable("CourseProgramStudent");
                });
            ...
            modelBuilder.Entity("CourseApp.Entity.CourseProgramStudent", b =>
                {
                    b.HasOne("CourseApp.Entity.CoursePrograms", "CoursePrograms")
                        .WithMany("CourseProgramStudent")
                        .HasForeignKey("CourseProgramsId");

                    b.HasOne("CourseApp.Entity.Student", "Student")
                        .WithMany("CourseProgramStudent")
            ...
            modelBuilder.Entity("CourseApp.Entity.CoursePrograms", b =>
                {
                    b.Navigation("CourseProgramStudent");
                });
